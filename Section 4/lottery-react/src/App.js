...
class App extends React.Component {
  //defining varibales in class body iis moved to constructor
  state = {
    manager: '',
    players: [],
    balance: '',
  ...
  onSubmit = async (event) => {
    ...
    this.setState({ message: 'Thank you for entering into the lottery!'});
  };
  ...
  render() {
    return (
      <div>
        ...
        <hr />
        <h4>Pick a winner!</h4>
        <button onClick={ this.onClick }>Click here to pick a winner</button>
        <hr />
